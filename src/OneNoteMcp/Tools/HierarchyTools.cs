...
public static class HierarchyTools
{
    ...
    public static string ListNotebooks() => ToolError.Guard(() =>
    {
    ...
    public static string GetHierarchy(
        ...
        [Description("Scope: notebooks, sections, or pages.")] string scope) => ToolError.Guard(() =>
    {
    ...
    public static string FindPages(
        [Description("Search query text.")] string query) => ToolError.Guard(() =>
    {
